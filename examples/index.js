...
let client = new GTAVLiveMapClient(options)
  ...
  .build()
  //[OPTIONAL] Add auto reconnect if connection will be lost In args, you need to pass the connection interval
  .registerAutoReconnect(1000 , () => {})
  ...
  .registerGlobalAction('Kick' , (args) => {} , (err) => {})